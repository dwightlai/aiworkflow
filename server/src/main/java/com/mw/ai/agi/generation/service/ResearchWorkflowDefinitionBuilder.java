    ...
    private static Map<String, Object> llmLoopStep() {
        Map<String, Object> step = llmConfig(
                ...
                """
                        ...
                        章节输出格式：{{section.outputFormat}}

                        当 outputFormat 为 document_collection 时，每条核心文件单独成段，严格按以下字段输出（每段空一行）：
                        题名：...
                        档号：...
                        形成时间：...
                        责任单位：...
                        ...
                        当 outputFormat 为 gallery 时，每条展品单独成段，严格按以下字段输出：
                        题名：...
                        图片引用：img_001
                        说明：...

                        当 outputFormat 为 analysis 时，输出资料解读正文。
                        其他情况输出普通 Markdown 正文。
